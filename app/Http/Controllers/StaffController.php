...
class StaffController extends Controller
{
    ...
    public function show(User $staff)
    {
        ...
        $earn_leave = LeaveRequest::usedEarnLeaveCount($staff->id);

        return view('app.staff.show', compact('staff', 'totalRequests', 'weekend_off', 'earn_leave'));
    }
    ...
    public function salarySlip(User $staff)
    {
        ...
        if(Input::get('send') == 'true') {
            ...
            Mail::to($staff)->send(new SalaryCredited($filename, $staff, $staff->details->salary_details->message));
